...
class ChatImportDialog(QDialog):
    ...
    def __initUi(self):
        ...
        importOptionsGrpBox = QGroupBox('Import Options')
        lay = QVBoxLayout()
        ...
        self.__dataGrpBox = QGroupBox('Content')
        ...
        manual_lbl = QLabel('You can import a JSON file created through the export feature.')
        lay = QVBoxLayout()
        lay.addWidget(manual_lbl)

        if self.__import_type == 'chatgpt':
            viewManualLbl = LinkLabel()
            viewManualLbl.setText('How to import your ChatGPT data')
